...
class PostController extends AbstractController
{
    ...
    public function publish(Post $post, EntityManagerInterface $em, Request $request, CategoryRepository $categoryRepository) : Response
    {
        ...
        {
            // Si l'article a déjà été publié,
            if ( $post->isIsPublished() ) 
            {
                // Retirons-la de la liste des publications
            ...
            // Demandons au gestionnaire des entités de preparer la requête de modification des données
            $em->persist($post);
        ...
        // Effectuons une redirection vers la page d'accueil de la section des articles
        return $this->redirectToRoute('admin.post.index');
    }
